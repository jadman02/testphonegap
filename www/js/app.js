...
'<a href="#tab3" onclick="dateUser();" class="datebutton disabled button link" style="border:1px solid white;border-radius:20px;font-family: \'Pacifico\', cursive;font-size:24px;">'+
'<span class="datefloat" style="padding:10px;border-radius:5px;margin-right:20px;">Datke</span>'+
   ...
   '</div>'+
       ...
       ' </a>'+
        ' <a href="#tab3" onclick="duckUser();" class="duckbutton disabled button link" style="border:1px solid white;border-radius:20px;font-family: \'Pacifico\', cursive;font-size:24px;">'+
        '<span class="duckfloat" style="padding:10px;border-radius:5px;margin-left:20px;">Duckk</span>'+
