...
if (!homewant || homewant =='offline'){
   ...
   $( ".statusbar-overlay" ).css("background-color","#ccc");
	...
	var swiperheight = $( window ).height() - 274;
	alert(swiperheight);
	$('.content-here').append(
...
'<div class="swiper-container swiper-helper-info" style="background-color:#ccc;color:white;margin-left:-10px;margin-right:-10px;">'+
