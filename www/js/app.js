   ...
   // '<span class="badge age-header header_'+i+'" style="display:none;text-align:left;float:left;width:100%;border-radius:0px;background-color:white;color:black;">'+i+'</span>'+
      '  <div class="swiper-container swiper-container-loaded swiper-'+i+'" style="display:none;height:'+slidewidth+'px;clear:both;background-color:white;">'+
       '<div class="agebuttonl blockleft_'+i+'" style="display:none;color:white;padding:3px;height:50px;width:200px;background-color:#2196f3;position:absolute;left:0;bottom:0px;z-index:9999;"><div style="float:left;"><i  class="pe-7s-angle-left pe-2x" style="margin-left:-9px;color:white;float:left;margin-top:3px"></i><span style="float:left;font-size:12px;margin-left:-5px;margin-top:2px;">'+i+' years old</span></div></div>'+
              ...
              '<div class="agebuttonr blockright_'+i+' single_'+i+'" style="display:none;margin-top:-10px;color:white;padding:3px;height:50px;width:30px;background-color:#ccc;position:absolute;right:0px;bottom:0px;z-index:9999;"><div style="float:right;"><span style="float:right;font-size:12px;margin-right:2px;margin-top:2px;">'+i+' years old</span></div></div>'+
