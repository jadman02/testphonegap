...
try {
 ...
 $('.recent-helper').html('<a href="#" class="button active" style="margin:10px;">Unlock</a><p style="padding:5px;">You need <span class="badge" style="color:red;">10</span> friends on Facebook to download Date or Duck to unlock this feature.</p><p style="color:#666;font-size:12px;margin-top:-10px;">We appreciate your help to grow this app!</p>');
 ...
 $('.recent-helper').html('<a href="#" class="button active" style="margin:10px;">Unlock</a><p style="padding:5px;"> You need <span class="badge" style="color:red;">10</span> friends on Facebook to download Date or Duck to unlock this feature.</p><p style="color:#666;font-size:12px;margin-top:-10px;">We appreciate your help to grow this app!</p>');
 $('.nearby-helper').html('<a href="#" class="button active" style="margin:10px;">Unlock</a><p style="padding:5px;"> Invite your friends to download Date or Duck to unlock this feature.</p><p style="color:#666;font-size:12px;margin-top:-10px;">We appreciate your help to grow this app!</p>');
