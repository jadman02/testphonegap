...
'<input id="datemessageq" placeholder="Message (optional)" style="width: calc(100% - 70px);margin-left:5px;background-color:white;margin-top:5px;max-height:44px;" type="text">'+ 
