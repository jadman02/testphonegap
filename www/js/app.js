...
'<input id="datemessageq" placeholder="Message (optional)" style="width: calc(100% - 70px);color:white;background-color:#2196f3;margin-top:5px;max-height:44px;" type="text">'+ 
