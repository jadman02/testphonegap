...
//$( ".nametag" ).removeClass('whitetext');
 ...
 '<div class="popup infopopup" style="background-color:transparent;margin-top:44px;height:calc(100% - 127px);background: -webkit-linear-gradient(270deg, rgba(255,255,255,0) 0%, rgba(255,255,255,0.17) 80%, rgba(255,255,255,1) 100%);" >'+
...
'<div class="swiper-container swiper-questions" style="height:100%;overflow-y:scroll;will-change: opacity;" onscroll="delayYo()">'+
