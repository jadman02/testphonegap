  ...
  //  if (calcrownumber == 0){rownumber = 3;columnslides=9;}
   ...
   // '<span class="badge age-header header_'+i+'" style="display:none;text-align:left;float:left;width:100%;border-radius:0px;background-color:white;color:black;">'+i+'</span>'+
      '  <div class="swiper-container swiper-container-loaded swiper-'+i+'" style="display:none;height:'+slidewidth+'px;clear:both;background-color:white;">'+
       '<div class="agebuttonl blockleft_'+i+'" style="display:none;color:white;padding:3px;height:'+slidewidth *0.5+'px;width:50px;background-color:#2196f3;position:absolute;left:0;top:50%;z-index:9999;margin-top:-10px;"><div style="float:left;"><i  class="pe-7s-angle-left pe-3x" style="margin-left:-9px;color:white;float:left;margin-top:3px"></i><span style="float:left;font-size:12px;margin-left:-5px;margin-top:2px;">'+i+'</span></div></div>'+
              '<div class="agebuttonr blockright_'+i+' multiple_'+i+'" style="display:none;margin-top:-10px;color:white;padding:3px;height:'+slidewidth+'px;width:30px;background-color:#2196f3;position:absolute;right:0px;top:75%;z-index:9999;margin-top:-7.5px;"><div style="float:right;"><i  class="pe-7s-angle-right pe-3x" style="margin-right:-9px;color:white;float:right;margin-top:3px"></i><span style="float:right;font-size:12px;margin-right:-5px;margin-top:2px;">'+i+'</span></div></div>'+
