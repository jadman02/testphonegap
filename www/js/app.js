...
'<div style="z-index:99999999;margin-top:0px;display:none;background-color:white;margin-left:20px;margin-right:20px;border-radius:20px;" class="prof_'+i+' infoprofile availyo_'+ new_all[i].id+' profileyo_'+ new_all[i].id+'">'+
