...
'<div style="z-index:99999999;margin-top:15px;display:none;background-color:white;border-radius:20px;margin-bottom:20px;" class="prof_'+i+' infoprofile availyo_'+ new_all[i].id+' profileyo_'+ new_all[i].id+'">'+
