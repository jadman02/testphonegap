...
//$( ".nametag" ).removeClass('whitetext');
 ...
 '<div class="popup infopopup" style="background-color:transparent;margin-top:44px;height:calc(100% - 147px);" >'+
...
'<div style="z-index:99999999;margin-top:50px;display:none;background-color:white;margin-left:20px;margin-right:20px;border-radius:20px;margin-bottom:20px;" class="prof_'+i+' infoprofile availyo_'+ new_all[i].id+' profileyo_'+ new_all[i].id+'">'+
